...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD~MMJ5yPLG8sRtoQb",
BOT_NUMBER: process.env.BOT_NUMBER || "+225 0151191073",
PASSWORD: process.env.PASSWORD || "Visostudio",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "viso-studio",
